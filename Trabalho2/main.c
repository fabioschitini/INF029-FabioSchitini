...
void testeInserirSemNada()
{
    ...
    printf("Fim do teste de inserir sem nada \n");
}
...
void testeExcluir()
{
    ...
    printf("Fim do teste de exlcuir\n");
}
...
void testeExcluirNumeroEspecifico()
{
    ...
    printf("Fim do teste de excluir el lugar especifico\n");
}
/*
9 [ 4, , ] 
*/
...
void testeListar()
{
    ...
    //printf("Valor de vet[1]==%i\n", vet[1]);
    //printf("Valor de vet[0]==%i\n", vet[0]);
    printf("%d\n", vet[0] == 7);
    printf("%d\n", vet[1] == -9);
...
*/
    ...
    printf("%d\n", vet[7] == 27);
    printf("%d\n", vet[8] == -6);
    printf("Fim do teste de retorna todos os numeros \n");
}
/*
2 [3,8,0]
5 [1,34,12,6,27,-6, , , , ]
...
void testeMudarTamanhoEstrutura()
{
    ...
    printf("%d\n", inserirNumeroEmEstrutura(2, 6) == SUCESSO);
    printf("%d\n", inserirNumeroEmEstrutura(2, 5) == SEM_ESPACO);
    printf("Fim do teste de modificar tamanho da estrutura \n");
}
